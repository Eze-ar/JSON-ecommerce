...
signIn.addEventListener(
    "click",
    () => (window.location.href = "../site/registrarse.html")
);
...
configuracion.addEventListener("click", () => {
    ...
    window.location.href = `../site/configuracion.html?id=${id}`;
});
carrito.addEventListener(
    "click",
    () => (window.location.href = "../site/carrito.html")
);
productos.addEventListener(
    "click",
    () => (window.location.href = "../site/administrador.html")
);
